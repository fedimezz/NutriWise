    ...
    <div class="container">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <button class="btn-primary" onclick="location.href='index.php?controller=aliment&action=index&area=front'">Commencer</button>
            </div>
        ...
        <section class="features">
            <div class="feature-card" onclick="location.href='index.php?controller=aliment&action=index&area=front'">
            ...
            <div class="feature-card" onclick="location.href='index.php?controller=recette&action=index&area=front'">
                <div class="feature-icon">📖</div>
        ...
        <div class="admin-access">
            ...
            <a href="index.php?controller=aliment&action=index&area=back">🥗 Aliments</a> | 
            <a href="index.php?controller=recette&action=index&area=back">📖 Recettes</a>
        </div>
