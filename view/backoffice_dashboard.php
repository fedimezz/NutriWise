...
<body>
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <nav>
                <a href="index.php?area=back" class="active">📊 Dashboard</a>
        ...
        <main class="main-content">
            ...
            <div class="section">
                <div class="section-header">
                    ...
                    <a href="index.php?controller=aliment&action=index&area=back" class="view-link">Voir tout →</a>
                </div>
                <table>
            ...
            <div class="section">
                <div class="section-header">
                    ...
                    <a href="index.php?controller=recette&action=index&area=back" class="view-link">Voir tout →</a>
                </div>
                <table>
