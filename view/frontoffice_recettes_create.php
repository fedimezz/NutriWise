...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        button { background: #4CAF50; color: white; padding: 12px 20px; border: none; border-radius: 5px; margin-top: 20px; cursor: pointer; font-size: 16px; width: 100%; }
...
<body>
    <div class="container">
        ...
        <p>Partagez votre recette avec la communaute NutriWise !</p>
        ...
        <div class="recipe-form">
            ...
            <form method="POST" action="../controller/index.php?controller=recette&action=store&area=front">
                ...
                <textarea name="description" rows="3" placeholder="Decrivez brievement votre recette..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                
                <label class="required">Instructions detaillees</label>
                <textarea name="instructions" rows="6" placeholder="1. Preparez les ingredients&#10;2. ..." required><?= htmlspecialchars($_POST['instructions'] ?? '') ?></textarea>
                
                <label class="required">Duree de preparation (minutes)</label>
                ...
                <label>Saison recommandee</label>
                <select name="saison">
                ...
                <label class="required">Ingredients (selectionnez les aliments utilises)</label>
